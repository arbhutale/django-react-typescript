...
export const transactionActions = { ...slice.actions, ...extraActions };
...
function createExtraActions() {
    ...
    function getById() {
        return createAsyncThunk(
            `${name}/getById`,
            async (id) => await fetchWrapper.get(`${baseUrl}/transactions/${id}`)
        );
    }
    ...
    function update() {
        return createAsyncThunk(
            ...
            async function ({ id, data }, { getState, dispatch }) {
                await fetchWrapper.put(`${baseUrl}/transactions/${id}/`, data);
            }
        );
    }
