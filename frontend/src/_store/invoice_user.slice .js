...
export const invoiceUserActions = { ...slice.actions, ...extraActions };
export const invoiceUserReducer = slice.reducer;
...
function createExtraActions() {
    ...
    function getAll() {
        return createAsyncThunk(
            `${name}/getAll`,
            async () => await fetchWrapper.get(`${baseUrl}/invoice_user/user/`)
        );
    }
