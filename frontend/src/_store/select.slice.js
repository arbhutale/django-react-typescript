...
export const selectActions = { ...slice.actions, ...extraActions };
...
function createExtraActions() {
    ...
    function register() {
        return createAsyncThunk(
            `${name}/transactions`,
            async (transaction) => await fetchWrapper.post(`${baseUrl}/transactions/`, transaction)
        );
    }
    ...
    function getAll() {
        return createAsyncThunk(
            `${name}/getAll`,
            async () => await fetchWrapper.get(`${baseUrl}/transactions/`)
        );
    }
    ...
    function getByCategory() {
        return createAsyncThunk(
            `${name}/category`,
            async (category) => await fetchWrapper.get(`${baseUrl}/category/${category}`)
        );
    }
